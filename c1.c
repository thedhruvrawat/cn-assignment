...
int main(void)
{
    ...
    char *token;
    fgets(buf, BUFLEN, input);      // Read the line from the file which contains comma-separated names. 
    // Assumption: The file only contains a single line which has names separated by a comma and terminated by a period
